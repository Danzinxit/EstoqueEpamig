...
export default function Header() {
  return (
    <header className="w-full bg-gradient-to-r from-green-700 to-green-600 py-2 px-8 flex items-center justify-between shadow-md">
      ...
      <img src="/epamig.png" alt="EPAMIG" className="h-12" style={{ background: 'transparent' }} />
        <div>
      ...
      <div className="flex items-center space-x-6">
        <div className="flex items-center space-x-4 text-white">
          ...
          <a href="https://portal.epamig.br" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center group transition-transform duration-200 hover:scale-110">
